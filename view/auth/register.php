            ...
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URL; ?>auth/doRegister" method="POST" name="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="firstname" class="form-control form-control-lg <?= $firstnameErr ?>"
                               value="<?= $firstnameData ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="lastname" class="form-control form-control-lg <?= $lastNameErr ?>"
                               value="<?= $lastnameData ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control form-control-lg <?= $emailErr ?>"
                               value="<?= $emailData ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control form-control-lg <?= $passwordErr ?>"
                               value="<?= $passwordData ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirm_password"
                               class="form-control form-control-lg <?= $confirmPasswordErr ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo URL; ?>auth/login" class="btn btn-light btn-block">Have an account?
                                Login</a>
                        </div>
                    </div>
                </form>
