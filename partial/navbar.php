    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link <?= (Session::get('controller_name') == 'Home') ? 'active' : '' ?>"
                       href="<?= URL ?>home">Home</a>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?= (Session::get('controller_name') == 'Categories') ? 'active' : '' ?>"
            ...
            <ul class="navbar-nav ml-auto">
                <?php if (Session::get('user')): ?>
                    <li class="nav-item">
                        <a class="nav-link d-flex <?= (Session::get('controller_name') == 'Dashboard') ? 'active' : '' ?>"
                           href="<?= URL ?>dashboard">
                            <img src="<?= (empty(Session::get('user')['image'])) ? DEFAULT_IMG : URL . Session::get('user')['image'] ?>"
                                 width="24" height="24" class="mr-2" alt="" style="border-radius: 50%">
